...
- PWAキャッシュ名を v1.12.1 に更新
- `manifest.json` の `start_url` を `index.html?v=1.12.1` に更新
...
- 商品登録画面のグループ入力例を、実運用向けの表現に調整

- 商品登録画面・商品マスタ編集画面のカテゴリ表示を「カテゴリ（任意）」に修正
- キャッシュ更新確認用に v1.12.1 へ更新
